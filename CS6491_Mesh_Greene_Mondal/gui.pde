...
//  if(key=='`') picking=true; 
  ...
  if(key=='w') {QPtubes.savePts("data/QPtubes");Ptubes.savePts("data/Ptubes");Qtubes.savePts("data/Qtubes");}   // save vertices to pts
...
void displayHeader()  // Displays title and authors face on screen
    ...
    fill(white); image(Db, width-Db.width/2-10,25,Db.width/2,Db.height/2); 
    image(Anna, width-Anna.width/2-Db.width/2 - 30,25,Anna.width/2,Anna.height/2); 
    }
...
String title ="Lattice Maker", name ="Anna Greene, Dibyendu Mondal",
