...
void sphere(pt P, float r) 
  {
    ...
    vec vecUp = U(V(0,0,rb));
    vec vecLeft = U(V(rb,0,0));
    vec vecFor = U(V(0,rb,0));
    sphere(r); 
    popMatrix();
...
void disk(pt P, vec I, vec J, float r) {
  ...
  beginShape(TRIANGLE_FAN);
    ...
    //normal(U(V(r*cos(a),I,r*sin(a),J))); v(P(P,r*cos(a),I,r*sin(a),J));
    normal(U(V(r*cos(a),I,r*sin(a),J))); v(P(P,r*cos(a),I,r*sin(a),J));
...
void collar(pt P, vec V, vec I, vec J, float r, float rd) {
  ...
  beginShape(QUAD_STRIP);
    for(float a=0; a<=TWO_PI+da; a+=da)
    {
      //normal(U(V(r*cos(a),I,r*sin(a),J,0,V))); v(P(P,r*cos(a),I,r*sin(a),J,0,V)); 
      //normal(U(V(rd*cos(a),I,rd*sin(a),J,1,V))); v(P(P,rd*cos(a),I,rd*sin(a),J,1,V));
      ...
      //{
      //  normal(U(V(r*cos(a),I,r*sin(a),J))); v(P(P,r*cos(a),I,r*sin(a),J,b,V)); 
      //  //normal(U(V(rd*cos(a),I,rd*sin(a),J,b+0.05,V))); v(P(P,rd*cos(a),I,rd*sin(a),J,b+0.05,V));
      //}
    }
  endShape();
  }
